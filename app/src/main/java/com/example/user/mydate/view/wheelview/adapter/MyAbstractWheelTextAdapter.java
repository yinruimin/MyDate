 ...
 */
package com.example.user.mydate.view.wheelview.adapter;
 ...
 */
public abstract class MyAbstractWheelTextAdapter extends AbstractWheelAdapter {
	 ...
	 *            the current context
	 */
	protected MyAbstractWheelTextAdapter(Context context) {
	 ...
	 */
	protected MyAbstractWheelTextAdapter(Context context, int itemResource) {
	 ...
	 */
	protected MyAbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
